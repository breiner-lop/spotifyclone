    ...
    <div className="bg-black h-screen text-white p-6 min-w-[240px] font-[Gotham-medium] relative">
      ...
      <div className="absolute bottom-24 text-sm">
        <Link href="https://open.spotify.com/download" passHref>
          <a className="flex items-center text-gray-default hover:text-white transition duration-300">
            <span>{downloadAppIcon}</span>
            <span className="ml-4">Instalar aplicación</span>
          </a>
        </Link>
      </div>
    </div>
